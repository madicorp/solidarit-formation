 ...
 * @since 0.1.0
 */
function _manually_load_formation_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/formation.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_formation_plugin' );
